...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
		...
		public GameObject invertmouseXtext;
		public GameObject invertmouseYtext;
		...
		public void  Start (){
			...
			// check mouse inverse
			if(PlayerPrefs.GetInt("InvertedX")==0){
				invertmouseXtext.GetComponent<TMP_Text>().text = "off";
			}
			else if(PlayerPrefs.GetInt("InvertedX")==1){
				invertmouseXtext.GetComponent<TMP_Text>().text = "on";
			}

			if(PlayerPrefs.GetInt("InvertedY")==0){
				invertmouseYtext.GetComponent<TMP_Text>().text = "off";
			}
			else if(PlayerPrefs.GetInt("InvertedY")==1){
				invertmouseYtext.GetComponent<TMP_Text>().text = "on";
			}
		...
		public void ResetConfiguration (){
			...
			PlayerPrefs.SetFloat("XSensitivity",1.0f);
			sensitivityXSlider.GetComponent<Slider>().value = PlayerPrefs.GetFloat("XSensitivity");
			
			PlayerPrefs.SetFloat("YSensitivity",1.0f);
			sensitivityYSlider.GetComponent<Slider>().value = PlayerPrefs.GetFloat("YSensitivity");
